...
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;I)V
    ...
    iget-object p2, p0, Ly1/k;->a:Lcom/google/android/material/textfield/TextInputLayout;
...
.method public a()V
    ...
    iget-object v0, p0, Ly1/k;->b:Landroid/content/Context;
    ...
    iget-object v2, p0, Ly1/k;->b:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/b;->h(FFFI)Lv1/f;

    move-result-object v3

    const/4 v4, 0x0

    invoke-virtual {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/b;->h(FFFI)Lv1/f;

    move-result-object v0

    iput-object v3, p0, Lcom/google/android/material/textfield/b;->n:Lv1/f;
    ...
    :cond_0
    iget-object v1, p0, Ly1/k;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    invoke-direct {v3, p0}, Ly1/g;-><init>(Lcom/google/android/material/textfield/b;)V
    ...
    invoke-direct {v1, p0}, Ly1/g;-><init>(Lcom/google/android/material/textfield/b;)V
    ...
    invoke-direct {v1, p0}, Ly1/j;-><init>(Lcom/google/android/material/textfield/b;)V
...
.method public final h(FFFI)Lv1/f;
    .locals 4

    .line 1
    new-instance v0, Lv1/i$b;

    invoke-direct {v0}, Lv1/i$b;-><init>()V
    ...
    invoke-virtual {v0, p2}, Lv1/i$b;->c(F)Lv1/i$b;

    invoke-virtual {v0, p2}, Lv1/i$b;->d(F)Lv1/i$b;

    invoke-virtual {v0}, Lv1/i$b;->a()Lv1/i;

    move-result-object p1

    iget-object p2, p0, Ly1/k;->b:Landroid/content/Context;
    ...
    .line 4
    invoke-static {p2, v1, v0}, Ls1/b;->c(Landroid/content/Context;ILjava/lang/String;)I
    ...
    .line 6
    iget-object v2, v1, Lv1/f;->b:Lv1/f$b;

    new-instance v3, Lm1/a;

    invoke-direct {v3, p2}, Lm1/a;-><init>(Landroid/content/Context;)V

    iput-object v3, v2, Lv1/f$b;->b:Lm1/a;

    invoke-virtual {v1}, Lv1/f;->x()V
    ...
    invoke-virtual {v1, p2}, Lv1/f;->q(Landroid/content/res/ColorStateList;)V

    .line 8
    iget-object p2, v1, Lv1/f;->b:Lv1/f$b;

    iget v0, p2, Lv1/f$b;->o:F

    cmpl-float v0, v0, p3

    if-eqz v0, :cond_0

    iput p3, p2, Lv1/f$b;->o:F
    ...
    iput-object p1, p2, Lv1/f$b;->a:Lv1/i;

    invoke-virtual {v1}, Lv1/f;->invalidateSelf()V

    .line 10
    iget-object p1, v1, Lv1/f;->b:Lv1/f$b;

    iget-object p2, p1, Lv1/f$b;->i:Landroid/graphics/Rect;
    ...
    iput-object p2, p1, Lv1/f$b;->i:Landroid/graphics/Rect;
