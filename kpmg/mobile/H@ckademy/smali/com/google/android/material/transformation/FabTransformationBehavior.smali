...
.method public u(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    .line 2
    invoke-static/range {p2 .. p2}, Lf0/u$i;->i(Landroid/view/View;)F

    move-result v7

    invoke-static/range {p1 .. p1}, Lf0/u$i;->i(Landroid/view/View;)F
    ...
    .line 5
    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lr/d;

    invoke-virtual {v0, v1, v2, v11}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Lr/d;)F

    move-result v11

    iget-object v12, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lr/d;

    invoke-virtual {v0, v1, v2, v12}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Lr/d;)F
    ...
    .line 9
    iget-object v8, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lr/d;

    invoke-virtual {v0, v1, v2, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Lr/d;)F

    move-result v8

    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lr/d;

    invoke-virtual {v0, v1, v2, v11}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Lr/d;)F
    ...
    iget-object v13, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lr/d;
    ...
    invoke-virtual {v0, v1, v2, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Lr/d;)F
    ...
    .line 15
    iget-object v10, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lr/d;
    ...
    invoke-virtual {v0, v1, v2, v10}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Lr/d;)F
    ...
    .line 20
    invoke-static {v9, v8, v14, v14}, Lv1/e;->n(FFFF)F

    move-result v15

    invoke-static {v9, v8, v6, v14}, Lv1/e;->n(FFFF)F

    move-result v21

    invoke-static {v9, v8, v6, v7}, Lv1/e;->n(FFFF)F

    move-result v6

    invoke-static {v9, v8, v14, v7}, Lv1/e;->n(FFFF)F
    ...
    .line 30
    iget-object v6, v0, Lz0/g;->a:Ll/g;
    ...
    invoke-virtual {v6, v11}, Ll/g;->k(I)Ljava/lang/Object;
    ...
    .line 42
    invoke-static/range {p1 .. p1}, Lf0/u$i;->g(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    :cond_1c
    instance-of v0, v2, La2/b;

    if-nez v0, :cond_1e

    instance-of v0, v2, La2/a;
    ...
    invoke-static {v0, v1}, Lr/d;->o(Landroid/animation/AnimatorSet;Ljava/util/List;)V
...
.method public final w(Landroid/view/View;Landroid/view/View;Lr/d;)F
    .locals 3
...
.method public final x(Landroid/view/View;Landroid/view/View;Lr/d;)F
    .locals 3
