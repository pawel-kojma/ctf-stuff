...
# direct methods
.method public constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILv1/i;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lv1/i;
...
.method public static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {v2, v3}, Lv1/e;->g(ZLjava/lang/Object;)V

    sget-object v2, Lv1/e;->b0:[I
    ...
    invoke-static {p0, p1, v0}, Ls1/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v0, v2, v3}, Lv1/i;->a(Landroid/content/Context;IILv1/c;)Lv1/i$b;

    move-result-object p0

    .line 2
    invoke-virtual {p0}, Lv1/i$b;->a()Lv1/i;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILv1/i;Landroid/graphics/Rect;)V
...
.method public b(Landroid/widget/TextView;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lv1/i;

    invoke-virtual {v0, v2}, Lv1/f;->setShapeAppearanceModel(Lv1/i;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lv1/i;

    invoke-virtual {v1, v2}, Lv1/f;->setShapeAppearanceModel(Lv1/i;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lv1/f;->q(Landroid/content/res/ColorStateList;)V
    ...
    .line 1
    invoke-static {p1, v0}, Lf0/u$d;->q(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
