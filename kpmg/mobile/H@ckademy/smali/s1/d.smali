...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    .line 2
    invoke-static {p1, v1, v3}, Ls1/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
...
.method public b(Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    invoke-static {p1, v0}, Lx/d;->a(Landroid/content/Context;I)Landroid/graphics/Typeface;
...
.method public c(Landroid/content/Context;Landroidx/activity/result/d;)V
    ...
    invoke-direct {v5, p0, p2}, Ls1/d$a;-><init>(Ls1/d;Landroidx/activity/result/d;)V

    const/4 v1, 0x0

    sget-object v3, Lx/d;->a:Ljava/lang/ThreadLocal;
    ...
    invoke-virtual {v5, p1, v1}, Lx/d$c;->a(ILandroid/os/Handler;)V
    ...
    invoke-static/range {v1 .. v8}, Lx/d;->b(Landroid/content/Context;ILandroid/util/TypedValue;ILx/d$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final d(Landroid/content/Context;)Z
    ...
    sget-object v2, Lx/d;->a:Ljava/lang/ThreadLocal;
    ...
    invoke-static/range {v0 .. v7}, Lx/d;->b(Landroid/content/Context;ILandroid/util/TypedValue;ILx/d$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method public e(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/activity/result/d;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Ls1/d;->f(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/activity/result/d;)V
    ...
    iget p1, p0, Ls1/d;->g:F

    iget p3, p0, Ls1/d;->e:F

    iget v0, p0, Ls1/d;->f:F

    iget-object v1, p0, Ls1/d;->a:Landroid/content/res/ColorStateList;
...
.method public f(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/activity/result/d;)V
    ...
    invoke-virtual {p0, p2, p1}, Ls1/d;->g(Landroid/text/TextPaint;Landroid/graphics/Typeface;)V
    ...
    .line 2
    invoke-virtual {p0, p2, v0}, Ls1/d;->g(Landroid/text/TextPaint;Landroid/graphics/Typeface;)V

    new-instance v0, Ls1/e;

    invoke-direct {v0, p0, p2, p3}, Ls1/e;-><init>(Ls1/d;Landroid/text/TextPaint;Landroidx/activity/result/d;)V

    invoke-virtual {p0, p1, v0}, Ls1/d;->c(Landroid/content/Context;Landroidx/activity/result/d;)V
...
.method public g(Landroid/text/TextPaint;Landroid/graphics/Typeface;)V
    ...
    iget p2, p0, Ls1/d;->k:F

    invoke-virtual {p1, p2}, Landroid/text/TextPaint;->setTextSize(F)V

    iget-boolean p2, p0, Ls1/d;->h:Z

    if-eqz p2, :cond_2

    iget p2, p0, Ls1/d;->i:F
