...
# direct methods
.method public constructor <init>(Lv1/l$d;FF)V
    .locals 0

    invoke-direct {p0}, Lv1/l$f;-><init>()V

    iput-object p1, p0, Lv1/l$b;->b:Lv1/l$d;

    iput p2, p0, Lv1/l$b;->c:F

    iput p3, p0, Lv1/l$b;->d:F
...
.method public a(Landroid/graphics/Matrix;Lu1/a;ILandroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lv1/l$b;->b:Lv1/l$d;

    .line 1
    iget v1, v0, Lv1/l$d;->c:F

    .line 2
    iget v2, p0, Lv1/l$b;->d:F

    sub-float/2addr v1, v2

    .line 3
    iget v0, v0, Lv1/l$d;->b:F

    .line 4
    iget v2, p0, Lv1/l$b;->c:F
    ...
    iget p1, p0, Lv1/l$b;->c:F

    iget v3, p0, Lv1/l$b;->d:F

    invoke-virtual {v0, p1, v3}, Landroid/graphics/Matrix;->preTranslate(FF)Z

    invoke-virtual {p0}, Lv1/l$b;->b()F
    ...
    sget-object v8, Lu1/a;->i:[I

    iget p1, p2, Lu1/a;->f:I

    const/4 p3, 0x0

    aput p1, v8, p3

    iget p1, p2, Lu1/a;->e:I
    ...
    iget-object p1, p2, Lu1/a;->c:Landroid/graphics/Paint;
