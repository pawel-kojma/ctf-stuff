...
.method public final a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lg/f;->a(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final b(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    ...
    iput-boolean v6, v2, Lg/f$b;->f:Z

    iput-boolean v6, v2, Lg/f$b;->g:Z
    ...
    .line 4
    iget-object v3, v2, Lg/f$b;->z:Lf0/b;
    ...
    invoke-virtual {v2}, Lg/f$b;->a()Landroid/view/SubMenu;

    goto :goto_3

    .line 5
    :cond_5
    iput-boolean v6, v2, Lg/f$b;->h:Z

    iget-object v3, v2, Lg/f$b;->a:Landroid/view/Menu;

    iget v11, v2, Lg/f$b;->b:I

    iget v12, v2, Lg/f$b;->i:I
    ...
    invoke-virtual {v2, v3}, Lg/f$b;->c(Landroid/view/MenuItem;)V
    ...
    .line 7
    iget-object v3, v2, Lg/f$b;->E:Lg/f;

    iget-object v3, v3, Lg/f;->c:Landroid/content/Context;

    sget-object v11, Lv1/e;->q:[I
    ...
    iput v11, v2, Lg/f$b;->b:I

    invoke-virtual {v3, v13, v7}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v11

    iput v11, v2, Lg/f$b;->c:I

    invoke-virtual {v3, v15, v7}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v11

    iput v11, v2, Lg/f$b;->d:I

    invoke-virtual {v3, v14, v7}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v11

    iput v11, v2, Lg/f$b;->e:I

    invoke-virtual {v3, v5, v6}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v11

    iput-boolean v11, v2, Lg/f$b;->f:Z

    invoke-virtual {v3, v7, v6}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v11

    iput-boolean v11, v2, Lg/f$b;->g:Z
    ...
    iput v11, v2, Lg/f$b;->i:I

    iget v11, v2, Lg/f$b;->c:I

    invoke-virtual {v3, v14, v11}, Landroidx/appcompat/widget/b1;->j(II)I

    move-result v11

    iget v12, v2, Lg/f$b;->d:I
    ...
    iput-object v11, v2, Lg/f$b;->k:Ljava/lang/CharSequence;
    ...
    iput-object v11, v2, Lg/f$b;->l:Ljava/lang/CharSequence;

    invoke-virtual {v3, v7, v7}, Landroidx/appcompat/widget/b1;->l(II)I

    move-result v11

    iput v11, v2, Lg/f$b;->m:I
    ...
    :cond_d
    iget v11, v2, Lg/f$b;->e:I

    :goto_6
    iput v11, v2, Lg/f$b;->r:I

    invoke-virtual {v3, v13, v7}, Landroidx/appcompat/widget/b1;->a(IZ)Z

    move-result v11

    iput-boolean v11, v2, Lg/f$b;->s:Z

    iget-boolean v11, v2, Lg/f$b;->f:Z

    invoke-virtual {v3, v15, v11}, Landroidx/appcompat/widget/b1;->a(IZ)Z

    move-result v11

    iput-boolean v11, v2, Lg/f$b;->t:Z

    iget-boolean v11, v2, Lg/f$b;->g:Z

    invoke-virtual {v3, v6, v11}, Landroidx/appcompat/widget/b1;->a(IZ)Z

    move-result v11

    iput-boolean v11, v2, Lg/f$b;->u:Z
    ...
    iput-object v11, v2, Lg/f$b;->y:Ljava/lang/String;
    ...
    iput-object v11, v2, Lg/f$b;->x:Ljava/lang/String;
    ...
    sget-object v13, Lg/f;->f:[Ljava/lang/Class;

    iget-object v14, v2, Lg/f$b;->E:Lg/f;

    iget-object v14, v14, Lg/f;->b:[Ljava/lang/Object;

    invoke-virtual {v2, v11, v13, v14}, Lg/f$b;->b(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_8
    iput-object v11, v2, Lg/f$b;->z:Lf0/b;
    ...
    iput-object v11, v2, Lg/f$b;->A:Ljava/lang/CharSequence;
    ...
    iput-object v11, v2, Lg/f$b;->B:Ljava/lang/CharSequence;
    ...
    iget-object v12, v2, Lg/f$b;->D:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v11, v2, Lg/f$b;->D:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_12
    iput-object v11, v2, Lg/f$b;->C:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, v11, v1, v3}, Lg/f;->b(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
...
.method public inflate(ILandroid/view/Menu;)V
    ...
    invoke-virtual {p0, v1, p1, p2}, Lg/f;->b(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    :try_end_0
