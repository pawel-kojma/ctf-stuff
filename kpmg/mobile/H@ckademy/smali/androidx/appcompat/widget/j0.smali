...
.method public b(Landroid/view/MotionEvent;I)Z
    ...
    iget-object v4, v1, Landroidx/appcompat/widget/j0;->h:Ljava/lang/reflect/Field;
    ...
    .line 11
    iget-object v3, v1, Landroidx/appcompat/widget/j0;->m:Li0/d;

    if-nez v3, :cond_12

    new-instance v3, Li0/d;

    invoke-direct {v3, v1}, Li0/d;-><init>(Landroid/widget/ListView;)V

    iput-object v3, v1, Landroidx/appcompat/widget/j0;->m:Li0/d;

    :cond_12
    iget-object v3, v1, Landroidx/appcompat/widget/j0;->m:Li0/d;

    .line 12
    iget-boolean v4, v3, Li0/a;->q:Z

    const/4 v4, 0x1

    iput-boolean v4, v3, Li0/a;->q:Z

    .line 13
    invoke-virtual {v3, v1, v2}, Li0/a;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z

    goto :goto_6

    :cond_13
    iget-object v2, v1, Landroidx/appcompat/widget/j0;->m:Li0/d;

    if-eqz v2, :cond_15

    .line 14
    iget-boolean v3, v2, Li0/a;->q:Z

    if-eqz v3, :cond_14

    invoke-virtual {v2}, Li0/a;->d()V

    :cond_14
    iput-boolean v5, v2, Li0/a;->q:Z
