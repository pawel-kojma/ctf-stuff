...
.field public static final j:Landroidx/appcompat/widget/r0$a;
...
.field public g:Landroidx/appcompat/widget/r0$c;
...
.method public static declared-synchronized c()Landroidx/appcompat/widget/r0;
    .locals 2
...
.method public final declared-synchronized a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Ll/d;->f(JLjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-virtual {p0, p1, v3, v4}, Landroidx/appcompat/widget/r0;->d(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object v1, p0, Landroidx/appcompat/widget/r0;->g:Landroidx/appcompat/widget/r0$c;
    ...
    invoke-virtual {p0, p1, v6}, Landroidx/appcompat/widget/r0;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v1}, Landroidx/appcompat/widget/r0;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v3, v4, v5}, Landroidx/appcompat/widget/r0;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method public final declared-synchronized d(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3, v1}, Ll/d;->e(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    iget-object p1, v0, Ll/d;->c:[J

    iget v2, v0, Ll/d;->e:I

    invoke-static {p1, v2, p2, p3}, Lv1/e;->f([JIJ)I

    move-result p1

    if-ltz p1, :cond_2

    iget-object p2, v0, Ll/d;->d:[Ljava/lang/Object;

    aget-object p3, p2, p1

    sget-object v2, Ll/d;->f:Ljava/lang/Object;
...
.method public declared-synchronized e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v0}, Landroidx/appcompat/widget/r0;->f(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized f(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    :goto_1
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/r0;->i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-nez v0, :cond_3

    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/r0;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 5
    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/r0;->j(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_3
    invoke-virtual {v0, p2, v1}, Ll/h;->a(ILjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/r0;->b:Ll/g;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/r0;->c:Ll/h;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/r0;->b:Ll/g;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/r0;->c:Ll/h;
    ...
    .line 6
    invoke-virtual {p0, p1, v4, v5}, Landroidx/appcompat/widget/r0;->d(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/r0;->c:Ll/h;

    invoke-virtual {v8, p2, v3}, Ll/h;->a(ILjava/lang/Object;)V

    iget-object v8, p0, Landroidx/appcompat/widget/r0;->b:Ll/g;
    ...
    invoke-virtual {p0, p1, v4, v5, v6}, Landroidx/appcompat/widget/r0;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/r0;->c:Ll/h;
...
.method public final j(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/r0;->h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 2
    iget-object p1, p0, Landroidx/appcompat/widget/r0;->g:Landroidx/appcompat/widget/r0$c;
    ...
    .line 11
    :cond_7
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/widget/r0;->k(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
