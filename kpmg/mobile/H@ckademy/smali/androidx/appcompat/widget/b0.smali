...
.method public e(Landroid/util/AttributeSet;I)V
    ...
    .line 2
    invoke-static/range {v1 .. v7}, Lf0/u;->o(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    .line 6
    invoke-virtual {v5, v13}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v3

    if-eqz v3, :cond_6

    invoke-virtual {v5, v13, v12}, Landroidx/appcompat/widget/b1;->a(IZ)Z
    ...
    :goto_0
    invoke-virtual {v0, v10, v5}, Landroidx/appcompat/widget/b0;->m(Landroid/content/Context;Landroidx/appcompat/widget/b1;)V
    ...
    :goto_1
    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v17

    if-eqz v17, :cond_8

    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/b1;->m(I)Ljava/lang/String;
    ...
    .line 10
    invoke-virtual {v6, v13}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v21

    if-eqz v21, :cond_a

    invoke-virtual {v6, v13, v12}, Landroidx/appcompat/widget/b1;->a(IZ)Z
    ...
    invoke-virtual {v6, v13}, Landroidx/appcompat/widget/b1;->m(I)Ljava/lang/String;
    ...
    invoke-virtual {v6, v12}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v2

    if-eqz v2, :cond_d

    invoke-virtual {v6, v12, v14}, Landroidx/appcompat/widget/b1;->f(II)I
    ...
    :cond_12
    iget-object v7, v0, Landroidx/appcompat/widget/b0;->i:Landroidx/appcompat/widget/e0;

    .line 14
    iget-object v1, v7, Landroidx/appcompat/widget/e0;->j:Landroid/content/Context;

    sget-object v3, Lv1/e;->j:[I
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/e0;->i:Landroid/widget/TextView;
    ...
    iput v1, v9, Landroidx/appcompat/widget/e0;->a:I
    ...
    :cond_17
    invoke-virtual {v9, v13}, Landroidx/appcompat/widget/e0;->b([I)[I

    move-result-object v7

    iput-object v7, v9, Landroidx/appcompat/widget/e0;->f:[I

    invoke-virtual {v9}, Landroidx/appcompat/widget/e0;->h()Z
    ...
    invoke-virtual {v9}, Landroidx/appcompat/widget/e0;->i()Z

    move-result v6

    if-eqz v6, :cond_1e

    iget v6, v9, Landroidx/appcompat/widget/e0;->a:I

    if-ne v6, v3, :cond_1f

    iget-boolean v6, v9, Landroidx/appcompat/widget/e0;->g:Z

    if-nez v6, :cond_1d

    iget-object v6, v9, Landroidx/appcompat/widget/e0;->j:Landroid/content/Context;
    ...
    :cond_1c
    invoke-virtual {v9, v4, v5, v1}, Landroidx/appcompat/widget/e0;->j(FFF)V

    :cond_1d
    invoke-virtual {v9}, Landroidx/appcompat/widget/e0;->g()Z
    ...
    .line 48
    invoke-static {v2, v4}, Landroidx/appcompat/widget/i0;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v1, v2}, Li0/g;->b(Landroid/widget/TextView;I)V
    ...
    invoke-static {v1, v4}, Li0/g;->c(Landroid/widget/TextView;I)V
    ...
    invoke-static {v1, v5}, Li0/g;->d(Landroid/widget/TextView;I)V
...
.method public f(Landroid/content/Context;I)V
    ...
    invoke-virtual {v1, v3, v0}, Landroidx/appcompat/widget/b1;->f(II)I
...
.method public g(Landroid/widget/TextView;Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)V
    ...
    invoke-static {p3, p1, v2, v0}, Lh0/a;->b(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;II)V
    ...
    invoke-static {p1, v2, p2}, Lh0/a;->a(Ljava/lang/CharSequence;II)Z
    ...
    invoke-static {p1, v7, v6}, Lh0/a;->a(Ljava/lang/CharSequence;II)Z
    ...
    invoke-static {p3, p1, v5, v3}, Lh0/a;->b(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;II)V
    ...
    :cond_d
    :goto_6
    invoke-static {p3, v3, p2, p2}, Lh0/a;->b(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;II)V
...
.method public final m(Landroid/content/Context;Landroidx/appcompat/widget/b1;)V
    ...
    invoke-virtual {p2, v5, p1, v9}, Landroidx/appcompat/widget/b1;->i(IILx/d$c;)Landroid/graphics/Typeface;
