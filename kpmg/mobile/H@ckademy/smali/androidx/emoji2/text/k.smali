...
.method public final run()V
    ...
    :try_start_1
    invoke-virtual {v0}, Landroidx/emoji2/text/j$b;->d()Lc0/l;

    move-result-object v1

    .line 2
    iget v2, v1, Lc0/l;->e:I
    ...
    .line 6
    sget-object v5, Ly/e;->a:Ly/j;

    const/4 v6, 0x0

    invoke-virtual {v5, v3, v6, v2, v4}, Ly/j;->b(Landroid/content/Context;Landroid/os/CancellationSignal;[Lc0/l;I)Landroid/graphics/Typeface;
    ...
    .line 8
    iget-object v1, v1, Lc0/l;->a:Landroid/net/Uri;

    .line 9
    invoke-static {v3, v6, v1}, Ly/k;->d(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v1}, Lr/d;->p(Ljava/nio/ByteBuffer;)Lm0/b;

    move-result-object v1

    invoke-direct {v3, v2, v1}, Landroidx/emoji2/text/l;-><init>(Landroid/graphics/Typeface;Lm0/b;)V
    :try_end_5
